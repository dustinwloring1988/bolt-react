...
export const CodeMirrorEditor = memo(
  ({
    ...
    const viewRef = useRef<EditorView | null | undefined>(undefined);
    const themeRef = useRef<Theme | null | undefined>(undefined);
    const docRef = useRef<EditorDocument | null | undefined>(undefined);
    ...
    extensions: [
      ...
      foldGutter({
        markerDOM: (open) => {
          ...
          icon.className = `fold-icon ${open ? <CaretDown/> : <CaretRight/>}`;
